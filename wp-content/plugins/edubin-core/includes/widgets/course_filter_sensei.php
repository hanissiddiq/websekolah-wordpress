...
use Elementor\Course_Filter_For_Sensei;


class Edubin_Elementor_Widget_Course_Filter_Sensei extends Widget_Base {
    ...
    public function get_keywords() {
        return [ 'Course Filter', 'Sensei course filter', 'Sensei course filter' , 'filter search', 'filter course' ];
    }
 ...
 // Style Meta tab section
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .sensei-course-loop-level',
            ]
        );
        $this->add_control(
            'Level_bg_color',
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-level' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .sensei-course-loop-level, .course__categories a',
            ]
        );
        $this->add_control(
            'cat_color',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-header-meta .sensei-course-wishlist a' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-loop-header-meta .sensei-course-wishlist:hover' => 'background-color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-header-meta .sensei-course-wishlist' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-loop-header-meta .sensei-course-wishlist:hover a' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-single-loop-meta i' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-loop-price>.price .sensei-loop-cart-btn-wrap a::before' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-single-loop-meta span' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-loop-author>div span' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .sensei-loop-author>.sensei-single-course-author-name a, .sensei-course-author, .edubin-course .author__name a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-loop-author>.sensei-single-course-author-name a' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-author' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-loop-author>.sensei-single-course-author-name a:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-author:hover' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'separator' => 'before',
                'selector' => '{{WRAPPER}} .sensei-loop-author>.sensei-course-lising-category a',
                'condition' => [
                    'course_style' => '1',
                ],
            ]
        ...
        //         'default' => '',
        //         'selectors' => [
        //             '{{WRAPPER}} .sensei-loop-author>.sensei-course-lising-category a' => 'color: {{VALUE}}',
        //         ],
        //         'condition' => [
        //             'course_style' => '1',
        //         ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-loop-author>.sensei-course-lising-category a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'separator' => 'before',
                'selector' => '{{WRAPPER}} .sensei-course-loop-price>.price, .course__content--meta .price',
            ]
        );
        $this->add_control(
            'price_color',
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-price>.price' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'separator' => 'before',
                'selector' => '{{WRAPPER}} .sensei-course-loop-price>.price .sensei-loop-cart-btn-wrap a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-price>.price .sensei-loop-cart-btn-wrap a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-price>.price .sensei-loop-cart-btn-wrap a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-title h2 a' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-col .sensei-course-body h3 a' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .sensei-course-loop-title h2 a, .sensei-course-col .sensei-course-body h3 a, .course__title a',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .sensei-course-col .sensei-course-body h3' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', ],
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-col .sensei-course-body h3' => 'height: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .sensei-course-loop-title h2 a:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .sensei-course-col .sensei-course-body h3 a:hover' => 'color: {{VALUE}}',
        ...
        $this->start_controls_section(
            'sensei_course_excerpt_style_section',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .edubin-sensei-courses-addons .edubin-sensei-excerpt p' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-sensei-courses-addons .edubin-sensei-excerpt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    $selected_language= !empty($_GET['sensei_course_language']) ? (array) $_GET['sensei_course_language'] : array();
    ...
    $course_terms_language = get_terms(array(
        'taxonomy' => 'sensei_course_language',
        'hide_empty' => true,
    ));

    $course_levels =  edubin_sensei_course_level();

    $course_level_filter = !empty($selected_level) && !in_array('all_levels', $selected_level) ? array(
        'key' => 'edubin_sensei_course_level_key',
        'value' => $selected_level,
        'compare' => 'IN',
    ) : array();

    // $course_level_filter = array(
    //         'key' => '_price',
    //         'value' => array(50, 100),
    //         'compare' => 'BETWEEN',
    //         'type' => 'NUMERIC'
    ...
    if (!empty($_GET['sensei_course_filter'])) {
        $course_filter = sanitize_text_field($_GET['sensei_course_filter']);
    }
        ...
        <div class="edubin-course-filter-wrapper"> 
            ...
            <form class="edubin-sidebar-filter" action="<?php echo esc_url($finalurl); ?>" method="get">
                <input type="hidden" name="s" value="<?php echo get_search_query(); ?>">
                    ...
                    <?php $sensei_filter_object = new \Sensei_Course_filter_Nasted_Cat();
                       $sensei_filter_object->render_terms('category');
                    ?>
                    ...
                    <?php } ?>
                        ...
                        <div class="filter-content">
                            ...
                            foreach ($course_authors as $user) {
                                if ( edubin_count_user_posts_by_type( $user->ID, 'course') ) {
                            ?>
                                ...
                                <?php $user_post_count = edubin_count_user_posts_by_type( $user->ID, 'course'); ?>
                    ...
                    <?php if ($settings['show_filter_language']): ?>
                        ...
                        <h4 class="widget-title"><?php echo esc_html($settings['filter_language_text']); ?></h4>
                            <div class="filter-content">
                            <?php
                                foreach ($course_terms_language as $sensei_course_language) {
                            ?>
                                <label for="tag-<?php echo esc_attr($sensei_course_language->slug) ?>">
                                    <input
                                        type="checkbox"
                                        name="sensei_course_language[]"
                                        value="<?php echo esc_attr($sensei_course_language->term_id) ?>"
                                        id="tag-<?php echo esc_attr($sensei_course_language->slug) ?>"
                                        <?php echo in_array($sensei_course_language->term_id, $selected_language) ? 'checked="checked"' : ''; ?>
                                    >
                                    <span class="filter-checkbox"><?php echo esc_html($sensei_course_language->name) ?></span>

                                    <?php if ($settings['show_filter_language_count']) { ?>
                                        <span class="filter-checkbox-count"><?php echo esc_attr('('. $sensei_course_language->count .')');?></span>
                                    <?php } ?>
            ...
            <?php if ($settings['show_filter_order']): ?>
               <div class="filter__top edubin-course-order">
                   <form class="edubin-course-filter-form" method="get">
                        <select name="sensei_course_filter" class="small">
                            <option value="newest_first" <?php if (isset($_GET["sensei_course_filter"]) ? selected("newest_first", $_GET["sensei_course_filter"]) : "");?> ><?php echo esc_html($settings['filter_newly_published']); ?></option>
                            <option value="oldest_first" <?php if (isset($_GET["sensei_course_filter"]) ? selected("oldest_first", $_GET["sensei_course_filter"]) : "");?>><?php echo esc_html($settings['filter_oldest_published']); ?></option>
                            <option value="course_title_az" <?php if (isset($_GET["sensei_course_filter"]) ? selected("course_title_az", $_GET["sensei_course_filter"]) : "");?>><?php echo esc_html($settings['filter_a_to_z']); ?></option>
                            <option value="course_title_za" <?php if (isset($_GET["sensei_course_filter"]) ? selected("course_title_za", $_GET["sensei_course_filter"]) : "");?>><?php echo esc_html($settings['filter_z_to_a']); ?></option>
                        </select>
                    </form>
               </div>
            <?php endif; ?>
            ...
            <div class="edubin-lp-course-wrapper-<?php echo esc_attr($settings['course_style']); ?>">
                ...
                <div id="edubindiv1" class="row tpc_g_30 layout__<?php echo esc_attr($settings['course_style']); ?>">
                    <?php
                     ...
                     ?>
                    <?php require EDUBIN_ADDONS_PL_PATH . 'includes/widgets/tpl-part/sensei/sensei_filter_grid.php'; ?>
             ...
             <!--Product List-->         
              <div id="edubindiv2" class="row tpc_g_30 layout__<?php echo esc_attr($settings['course_style']); ?>" style="display:none;">
                    <?php
                        ...
                        while( $query->have_posts() ): $query->the_post();
                     ?>
                    <?php require EDUBIN_ADDONS_PL_PATH . 'includes/widgets/tpl-part/sensei/sensei_filter_list.php'; ?>
                    <?php endwhile; wp_reset_postdata(); wp_reset_query(); ?>
                    <?php endif; ?>
              </div>
