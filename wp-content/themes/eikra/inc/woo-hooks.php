...
if ( function_exists( 'YITH_WCWL_Frontend' ) && class_exists( 'YITH_WCWL_Ajax_Handler' )  ) {
    ...
    add_action( 'wp_ajax_eikra_add_to_wishlist',            'eikra_add_to_wishlist' );
    add_action( 'wp_ajax_nopriv_eikra_add_to_wishlist',     'eikra_add_to_wishlist' );
}

function eikra_add_to_wishlist() {
    check_ajax_referer( 'eikra_wishlist_nonce', 'nonce' );
