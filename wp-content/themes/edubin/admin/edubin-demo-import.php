...
function edubin_import_files()
{
    return array(
        ...
        array(
            ...
            'local_import_file'            => trailingslashit(get_template_directory()) . 'admin/demo/sensei-red/content.xml',
            'local_import_widget_file'     => trailingslashit(get_template_directory()) . 'admin/demo/sensei-red/widget_data.wie',
            'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'admin/demo/sensei-red/customizer.dat',
